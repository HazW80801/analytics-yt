...
export default function Header() {
    ...
    return (
        <div className="w-full border-b border-white/5 sticky top-0 bg-black z-50
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger className="text-white outline-none p-0 m-0 border-none">
                        <div className="flex space-x-2 items-center justify-center hover:opacity-50">
                            ...
                            <img alt="name" className="h-8 w-8 rounded-full" src={user && user?.user_metadata.avatar_url} />
                        </div>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent className="bg-[#0a0a0a] border-white/5 outline-none 
